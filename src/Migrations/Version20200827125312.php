...
final class Version20200827125312 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE car_ride ADD start_postal_code VARCHAR(255) NOT NULL, ADD start_city VARCHAR(255) NOT NULL, ADD start_address VARCHAR(255) NOT NULL, ADD end_postal_code VARCHAR(255) NOT NULL, ADD end_city VARCHAR(255) NOT NULL, ADD end_address VARCHAR(255) NOT NULL, DROP start_address, DROP end_address, DROP km_number, DROP start_postal_code, DROP start_city, DROP end_postal_code, DROP end_city, CHANGE reservation_id reservation_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation_user (reservation_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_9BAA1B21A76ED395 (user_id), INDEX IDX_9BAA1B21B83297E7 (reservation_id), PRIMARY KEY(reservation_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
