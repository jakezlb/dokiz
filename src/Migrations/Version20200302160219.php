...
final class Version20200302160219 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE car_ride (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, status_id INT NOT NULL, departure VARCHAR(255) NOT NULL, arrival VARCHAR(255) NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, adress_point_departure VARCHAR(255) NOT NULL, adress_point_arrival VARCHAR(255) NOT NULL, km_number INT NOT NULL, INDEX IDX_5057687CB83297E7 (reservation_id), INDEX IDX_5057687C6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
