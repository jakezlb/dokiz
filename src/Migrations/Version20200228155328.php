 ...
 */
final class Version20200228155328 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE key_car (id INT AUTO_INCREMENT NOT NULL, car_id INT DEFAULT NULL, INDEX IDX_A334FB4DC3C6F69F (car_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
