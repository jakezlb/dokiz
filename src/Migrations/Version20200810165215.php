 ...
 */
final class Version20200810165215 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE car CHANGE society_id society_id INT DEFAULT NULL, CHANGE car_url car_url VARCHAR(255) NOT NULL, CHANGE name name VARCHAR(20) DEFAULT NULL, CHANGE fuel fuel VARCHAR(200) DEFAULT NULL');
        $this->addSql('ALTER TABLE car_ride CHANGE reservation_id reservation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE key_car ADD is_taken TINYINT(1) NOT NULL, CHANGE car_id car_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reservation CHANGE cars_id cars_id INT DEFAULT NULL, CHANGE date_reservation date_reservation DATETIME NOT NULL, CHANGE is_confirmed is_confirmed TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE car CHANGE society_id society_id INT DEFAULT NULL, CHANGE car_url car_url VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(20) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE fuel fuel VARCHAR(200) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE car_ride CHANGE reservation_id reservation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE key_car DROP is_taken, CHANGE car_id car_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reservation CHANGE cars_id cars_id INT DEFAULT NULL, CHANGE date_reservation date_reservation DATETIME DEFAULT \'NULL\', CHANGE is_confirmed is_confirmed TINYINT(1) DEFAULT \'NULL\'');
