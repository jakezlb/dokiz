 ...
 */
final class Version20200619135021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE car_ride_id car_ride_id INT DEFAULT NULL, CHANGE cars_id cars_id INT DEFAULT NULL');
